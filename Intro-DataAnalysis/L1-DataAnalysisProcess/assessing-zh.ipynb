   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "\n",
       "       symmetry_mean          ...            radius_max  texture_max  \\\n",
       "count     504.000000          ...            569.000000   548.000000   \n",
       "mean        0.181091          ...             16.261896    25.660803   \n",
       "std         0.027899          ...              4.841175     6.202916   \n",
       "min         0.106000          ...              7.930000    12.020000   \n",
       "25%         0.161800          ...             13.010000    21.017500   \n",
       "50%         0.178950          ...             14.970000    25.370000   \n",
       "75%         0.195750          ...             18.760000    29.675000   \n",
       "max         0.304000          ...             36.040000    49.540000   \n",
       "\n",
       "       perimeter_max     area_max  smoothness_max  compactness_max  \\\n",
       "count     569.000000   569.000000      521.000000       569.000000   \n",
       "mean      107.211142   880.163796        0.132090         0.254557   \n",
       "std        33.621975   570.498628        0.022685         0.158042   \n",
       "min        50.410000   185.200000        0.071170         0.027290   \n",
       "25%        84.110000   515.300000        0.116600         0.146000   \n",
       "50%        97.650000   686.500000        0.131200         0.211900   \n",
       "75%       125.100000  1070.000000        0.145000         0.339900   \n",
       "max       251.200000  4254.000000        0.222600         1.058000   \n",
       "\n",
       "       concavity_max  concave_points_max  symmetry_max  fractal_dimension_max  \n",
       "count     569.000000          569.000000    504.000000             569.000000  \n",
       "mean        0.271681            0.114377      0.288856               0.084012  \n",
       "std         0.208298            0.065760      0.062520               0.018151  \n",
       "min         0.000000            0.000000      0.156500               0.055040  \n",
       "25%         0.112500            0.064020      0.247650               0.071270  \n",
       "50%         0.226700            0.100100      0.280650               0.080040  \n",
       "75%         0.385300            0.162500      0.317525               0.092110  \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "13          ...                 16.84          NaN         112.00     876.5   \n",
       "14          ...                 15.03        32.01         108.80     697.7   \n",
       "15          ...                 17.46        37.13         124.10     943.2   \n",
       "16          ...                 19.07        30.88         123.40    1138.0   \n",
       "17          ...                 20.96          NaN         136.80    1315.0   \n",
       "18          ...                 27.32        30.88         186.80    2398.0   \n",
       "19          ...                 15.11        19.26          99.70     711.2   \n",
       "\n",
       "    smoothness_max  compactness_max  concavity_max  concave_points_max  \\\n",
       "0           0.1622           0.6656         0.7119             0.26540   \n",
       "1           0.1238           0.1866         0.2416             0.18600   \n",
       "2           0.1444           0.4245         0.4504             0.24300   \n",
       "3              NaN           0.8663         0.6869             0.25750   \n",
       "4           0.1374           0.2050         0.4000             0.16250   \n",
       "5           0.1791           0.5249         0.5355             0.17410   \n",
       "6           0.1442           0.2576         0.3784             0.19320   \n",
       "7           0.1654           0.3682         0.2678             0.15560   \n",
       "8           0.1703           0.5401         0.5390             0.20600   \n",
       "9           0.1853           1.0580         1.1050             0.22100   \n",
       "10          0.1181           0.1551         0.1459             0.09975   \n",
       "11          0.1396           0.5609         0.3965             0.18100   \n",
       "12          0.1037           0.3903         0.3639             0.17670   \n",
       "13          0.1131           0.1924         0.2322             0.11190   \n",
       "14          0.1651           0.7725         0.6943             0.22080   \n",
       "15          0.1678           0.6577         0.7026             0.17120   \n",
       "16          0.1464           0.1871         0.2914             0.16090   \n",
       "17          0.1789           0.4233         0.4784             0.20730   \n",
       "18          0.1512           0.3150         0.5372             0.23880   \n",
       "19          0.1440           0.1773         0.2390             0.12880   \n",
       "\n",
       "    symmetry_max  fractal_dimension_max  \n",
       "0         0.4601                0.11890  \n",
       "1         0.2750                0.08902  \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "\n",
       "     smoothness_max  compactness_max  concavity_max  concave_points_max  \\\n",
       "567         0.16500          0.86810         0.9387               0.265   \n",
       "568         0.08996          0.06444         0.0000               0.000   \n",
       "\n",
       "     symmetry_max  fractal_dimension_max  \n",
       "567        0.4087                0.12400  \n",
       "568        0.2871                0.07039  \n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "         id diagnosis  radius_max  texture_max  perimeter_max  area_max  \\\n",
       "0    842302         M       25.38          NaN         184.60    2019.0   \n",
       "1    842517         M       24.99        23.41         158.80    1956.0   \n",
       "2  84300903         M       23.57        25.53         152.50    1709.0   \n",
       "3  84348301         M       14.91        26.50          98.87     567.7   \n",
       "4  84358402         M       22.54        16.67         152.20    1575.0   \n",
       "\n",
       "   smoothness_max  compactness_max  concavity_max  concave_points_max  \\\n",
       "0          0.1622           0.6656         0.7119              0.2654   \n",
       "1          0.1238           0.1866         0.2416              0.1860   \n",
